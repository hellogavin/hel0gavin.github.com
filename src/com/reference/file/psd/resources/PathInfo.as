...
package com.reference.file.psd.resources {
	...
	public class PathInfo {
		private var _selector:uint;
		public function get selector():uint { return _selector; }
		
		public function PathInfo( stream:ByteArray ) {
			_selector = stream.readUnsignedShort();
			...
			PSDParser.log("path type: " + types[ selector ] );
		}
	}
}